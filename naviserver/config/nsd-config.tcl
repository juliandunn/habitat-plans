...
ns_param        serverlog           {{pkg.svc_var_path}}/error.log
ns_param        pidfile             {{pkg.svc_var_path}}/nsd.pid
...
ns_param        pagedir             {{pkg.svc_data_path}}
#ns_param       serverdir           ""
...
ns_param        file                {{pkg.svc_var_path}}/access.log
