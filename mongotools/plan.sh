...
pkg_source=https://github.com/mongodb/mongo-tools/archive/r3.2.10.tar.gz
...
do_build() {
  ./set_gopath.sh
  export GOPATH=/hab/cache/src/mongo-tools-r3.2.10/.gopath:/hab/cache/src/mongo-tools-r3.2.10/vendor
